...
const Privacy = () => {
  ...
  return (
    <div className="h-full">
      ...
      <div
        data-aos="fade-down"
        className="prose text-primary-dark overflow-y-auto pb-12 px-4 w-[60] m-auto text-justify">
        <div className="text-4xl prose-h2: font-semibold" id="privacy-policy">
          Privacy Policy
        </div>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              Agreement) refers to Correlation Systems LTD, 53 HaMasger Street
              6721706 Tel Aviv-Yafo, Israel.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              Website refers to Correlation Systems - UtiP-DAM, accessible from{' '}
              <a href="/">https://ngi.cs.co.il/</a>
            </p>
          </li>
          <li>
            <p>
        ...
        <ul>
          <li>
            <p>
              Email address: only when creating an an account and/or submitting
              a contact form via the contact page
            </p>
          </li>
          <li>
            <p>
              First name and last name: only when submitting a contact form via
              the contact page
            </p>
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              (e.g: when you contact a dataset owner)
            </p>
          </li>
          <li>
            <p>
        ...
        <ul className="mb-20">
          <li>
            ...
            <a href="/contact">https://ngi.cs.co.il/contact</a>
          </li>
        </ul>
      </div>
    </div>
